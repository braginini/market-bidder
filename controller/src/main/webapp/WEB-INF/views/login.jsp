...
<head>
	...
	<!--[if lt IE 9]>
    <script src="../../resources/js/mylibs/polyfills/selectivizr-min.js"></script><![endif]-->
	<!--[if lt IE 10]><script src="resources/js/mylibs/charts/excanvas.js"></script><![endif]-->
	<!--[if lt IE 10]>
	...
	<script>window.jQuery.ui || document.write('<script src="../../resources/js/libs/jquery-ui-1.8.21.min.js"><\/script>')</script>
	
		<!-- Do the same with Lo-Dash.js -->
	<script src="http://cdnjs.cloudflare.com/ajax/libs/lodash.js/0.4.2/lodash.min.js"></script>
	<script>window._ || document.write('<script src="../../resources/js/libs/lodash.min.js"><\/script>')</script>
...
<body class=login>
		...
		<div class="container_12">
			...
			<div class="left">
				<ul class="breadcrumb">
					...
					<li><a href="javascript:void(0);">Вход в систему</a></li>
			...
			<!--<div class="right">
				<ul>
					...
					<li class="red"><a href="#">Покупка</a></li>
					
				</ul>
			</div>&lt;!&ndash; End of .right &ndash;&gt;-->
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<!-- Your logos -->
			<a href="/tf-mango/"><img src="../../resources/img/logo-light.png" alt="Mango" width="210" height="67"></a>
			<a class="phone-title" href="login.html"><img src="../../resources/img/logo-mobile.png" alt="Mango" height="22" width="70" /></a>
	...
	<section id="login" class="container_12 clearfix">
		...
		<form action="j_spring_security_check" method="post" class="box validate">
		
			<div class="header">
				<h2><span class="icon icon-lock"></span>Вход</h2>
			</div>
			...
			<div class="content">
				...
				<div class="login-messages">
					<div class="message welcome">Добро пожаловать!</div>
					<div class="message failure">Неверный логин или пароль.</div>
				</div>
				...
				<div class="form-box">
					...
					<div class="row">
						...
						<div>
							<input tabindex=1 type="text" class="required noerror" name=j_username id=j_username />
						</div>
					</div>
					...
					<div class="row">
						<label for="j_password">
							...
							<small><a href="javascript:void(0);" id="">Забыли пароль?</a></small>
						</label>
						<div>
							<input tabindex=2 type="password" class="required noerror" name=j_password id=j_password />
						</div>
					</div>
			...
			<div class="actions">
				<div class="left">
					<div class="rememberme">
						<input tabindex=4 type="checkbox" name="login_remember" id="login_remember" checked /><label for="login_remember">Запомнить?</label>
					</div>
				</div>
				<div class="right">
					<input tabindex=3 type="submit" value="Войти" name="login_btn" />
				</div>
			</div><!-- End of .actions -->
