...
<head>
	...
	<!--[if IE 8]>
    <link rel="stylesheet" href="../../resources/css/fonts/font-awesome-ie7.css"><![endif]-->
	...
	<!--[if lt IE 9]>
    <script src="../../resources/js/mylibs/polyfills/selectivizr.js"></script><![endif]-->
	<!--[if lt IE 10]>
    <script src="../../resources/js/mylibs/polyfills/excanvas.js"></script><![endif]-->
	<!--[if lt IE 10]>
    <script src="../../resources/js/mylibs/polyfills/classlist.js"></script><![endif]-->
...
<body>
	...
	<div id="lock-screen" title="Screen Locked">
		...
		<a href="/j_spring_security_logout" class="header right button grey flat">Logout</a>
		...
		<div class="container_12">
			...
			<div class="left">
				<ul class="breadcrumb">
					...
					<li><a href="dashboard.html">Система</a></li>
					<li><a href="javascript:void(0);">Домашняя</a></li>
                             ...
                             <div class="popup">
                                 ...
                                 <div class="content mail">
                                     <ul>
                                         ...
                                         <li>
                                             <div class="avatar">
                                                 <img src="../../resources/img/elements/mail/avatar.png" height=40 width=40/>
                                             </div>
                                             <div class="info">
                                         ...
                                         <li>
                                             <div class="avatar">
                                                 <img src="../../resources/img/elements/mail/mail.png" height=40 width=40/>
                                             </div>
                                             <div class="info">
	...
	<header class="container_12">
		...
		<!-- Your logos -->
		<a href="dashboard.html"><img src="../../resources/img/logo.png" alt="Mango" width="191" height="60"></a>
		...
		<aside>
			<div class="top">
				...
				<nav><ul class="collapsible accordion">
					...
					<li class="current"><a href="dashboard.html"><img src="../../resources/img/icons/packs/fugue/16x16/dashboard.png" alt="" height=16 width=16>Dashboard</a></li>
					
					<li>
						<a href="javascript:void(0);"><img src="../../resources/img/icons/packs/fugue/16x16/ui-layered-pane.png" alt="" height=16 width=16>UI Widgets<span class="badge">4</span></a>
						<ul>
					...
					<li>
						<a href="javascript:void(0);"><img src="../../resources/img/icons/packs/fugue/16x16/application-form.png" alt="" height=16 width=16>Form Elements</a>
						<ul>
					...
					<li>
						<a href="javascript:void(0);"><img src="../../resources/img/icons/packs/fugue/16x16/chart.png" alt="" height=16 width=16>Statistics / Charts<span class="badge">2</span></a>
						<ul>
					...
					<li>
						<a href="javascript:void(0);"><img src="../../resources/img/icons/packs/fugue/16x16/table.png" alt="" height=16 width=16>Tables</a>
						<ul>
					...
					<li>
						<a href="javascript:void(0);"><img src="../../resources/img/icons/packs/fugue/16x16/document-horizontal.png" alt="" height=16 width=16>Other Pages</a>
						<ul>
		...
		<section id="content" class="container_12 clearfix" data-sort=true>
			...
			<div class="grid_12">
				<div class="box">
					...
					<div class="header">
						<h2><img class="icon" src="../../resources/img/icons/packs/fugue/16x16/chart-up-color.png">Charts</h2>
			...
			<div class="grid_6">
				...
				<div class="box">
					...
					<div class="header">
						<h2><img class="icon" src="../../resources/img/icons/packs/fugue/16x16/receipt-invoice.png">Invoices statistics</h2>
					</div>
				...
				<form class="box validate">
					...
					<div class="header">
						<h2><img class="icon" src="../../resources/img/icons/packs/fugue/16x16/newspaper.png">Messages</h2>
					</div>
			...
			<div class="grid_6">
				<div class="box">
					...
					<div class="header">
						<h2><img class="icon" src="../../resources/img/icons/packs/fugue/16x16/calendar-select.png">Calendar</h2>
					</div>
			...
			<div class="grid_12">
				<div class="box">
					...
					<div class="header">
						<h2><img class="icon" src="../../resources/img/icons/packs/fugue/16x16/table.png">Table</h2>
					</div>
