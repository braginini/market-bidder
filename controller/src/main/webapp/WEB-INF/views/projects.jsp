		...
		<div class="container_12">
			...
			<div class="left">
				<ul class="breadcrumb">
					...
					<li><a href="javascript:void(0);">Проекты</a></li>
					<%--<li><a href="javascript:void(0);">dynamic</a></li>--%>
		...
		<aside>
			<div class="top">
				...
				<nav><ul class="collapsible accordion">
					...
					<li><a href="dashboard.html"><img src="../../resources/img/icons/packs/fugue/16x16/dashboard.png" alt="" height=16 width=16>Рабочий стол</a></li>
                    <li>
                        <a class="open" href="/projects"><img src="../../resources/img/icons/packs/fugue/16x16/table.png" alt="" height=16 width=16>Проекты</a>
				...
				<div class="box">
					...
					<div class="content">
						...
						<div class="tabletools">
							<div class="left">
								<a class="open-add-client-dialog" href="javascript:void(0);"><i class="icon-plus"></i>Добавить проект</a>
							</div>
							<div class="right"></div>
						</div>

						<table class="styled" <%--"dynamic styled with-prev-next" data-table-tools='{"display":true}'--%> id="projects">
							<thead>
								<tr>
									<th>ID</th>
