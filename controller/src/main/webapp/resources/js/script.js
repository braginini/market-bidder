...
(function($, mango, undefined){
	...
	mango.loaded(function(){
		...
		$('input:checkbox').checkbox({
			cls : 'checkbox',
			empty : 'resources/img/elements/checkbox/empty.png'
		});
	...
	mango.ready(function(){
		...
		mango.utils.preload([
			'resources/img/layout/navigation/arrow-active.png',
			'resources/img/layout/navigation/arrow-hover.png',
			'resources/img/layout/navigation/arrow.png',
			'resources/img/layout/navigation/bg-current.png',
			'resources/img/layout/navigation/bg-active.png',
			'resources/img/layout/navigation/bg-hover.png',
			'resources/img/layout/navigation/bg-normal.png'
		]);
		
		mango.utils.preload([
			'resources/img/layout/sidebar/bg-right.png',
			'resources/img/layout/sidebar/bg.png',
			'resources/img/layout/sidebar/divider.png',
			'resources/img/layout/sidebar/shadow-right.png',
			'resources/img/layout/sidebar/shadow.png',
			'resources/img/layout/sidebar-right/header-bg.png',
			'resources/img/layout/sidebar-right/nav-bg-hover.png',
			'resources/img/layout/sidebar-right/nav-bg.png'
		]);
		
		mango.utils.preload([
			'resources/img/layout/toolbar/bg.png',
			'resources/img/layout/toolbar/buttons/bg-active.png',
			'resources/img/layout/toolbar/buttons/bg-disabled.png',
			'resources/img/layout/toolbar/buttons/bg-hover.png',
			'resources/img/layout/toolbar/buttons/bg-red-active.png',
			'resources/img/layout/toolbar/buttons/bg-red-disabled.png',
			'resources/img/layout/toolbar/buttons/bg-red-hover.png',
			'resources/img/layout/toolbar/buttons/bg-red.png',
			'resources/img/layout/toolbar/buttons/bg.png',
			'resources/img/layout/toolbar/buttons/divider.png'
		]);
		
		mango.utils.preload(['resources/img/layout/footer/divider.png']);
		
				
		mango.utils.preload([
			'resources/img/layout/bg.png',
			'resources/img/layout/content/box/actions-bg.png',
			'resources/img/layout/content/box/bg.png',
			'resources/img/layout/content/box/header-bg.png',
			'resources/img/layout/content/box/menu-active-bg.png',
			'resources/img/layout/content/box/menu-arrow.png',
			'resources/img/layout/content/box/menu-bg.png',
			'resources/img/layout/content/box/menu-item-bg-hover.png',
			'resources/img/layout/content/box/menu-item-bg.png',
			'resources/img/layout/content/box/tab-hover.png',
			'resources/img/layout/content/toolbar/bg-shortcuts.png',
			'resources/img/layout/content/toolbar/bg.png',
			'resources/img/layout/content/toolbar/divider.png',
			'resources/img/layout/content/toolbar/popup-arrow.png',
			'resources/img/layout/content/toolbar/popup-header.png',
			'resources/img/layout/content/toolbar/user/arrow-normal.png',
			'resources/img/layout/content/toolbar/user/avatar-bg.png',
			'resources/img/layout/content/toolbar/user/avatar.png',
			'resources/img/layout/content/toolbar/user/bg-hover.png',
			'resources/img/layout/content/toolbar/user/bg-menu-hover.png',
			'resources/img/layout/content/toolbar/user/counter.png'
		]);
		
		
		mango.utils.preload([
			'resources/img/elements/alert-boxes/bg-error.png',
			'resources/img/elements/alert-boxes/bg-information.png',
			'resources/img/elements/alert-boxes/bg-note.png',
			'resources/img/elements/alert-boxes/bg-success.png',
			'resources/img/elements/alert-boxes/bg-warning.png',
			'resources/img/elements/alert-boxes/error.png',
			'resources/img/elements/alert-boxes/information.png',
			'resources/img/elements/alert-boxes/note.png',
			'resources/img/elements/alert-boxes/success.png',
			'resources/img/elements/alert-boxes/warning.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/breadcrumb/bg-active.png',
			'resources/img/elements/breadcrumb/bg-hover.png',
			'resources/img/elements/breadcrumb/divider-active.png',
			'resources/img/elements/breadcrumb/divider-hover.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/headerbuttons/bg-active.png',
			'resources/img/elements/headerbuttons/bg-hover.png'
		]);
	
		mango.utils.preload([
			'resources/img/elements/autocomplete/el-bg-hover.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/calendar/arrow-hover-bg.png'
		]);
		
		mango.utils.preload(['resources/img/elements/charts/hover-bg.png']);
		
		mango.utils.preload([
			'resources/img/elements/messages/button-active-bg.png',
			'resources/img/elements/messages/button-hover-bg.png'
		]);
		...
		mango.utils.preload([
			'resources/img/elements/mail/actions-bg.png',
			'resources/img/elements/mail/button-bg-disabled.png',
			'resources/img/elements/mail/button-bg-hover.png',
			'resources/img/elements/mail/button-bg.png',
			'resources/img/elements/mail/button-red-bg-hover.png',
			'resources/img/elements/mail/button-red-bg.png',
			'resources/img/elements/mail/button-red-disabled.png',
			'resources/img/elements/mail/hover-bg.png',
			'resources/img/elements/mail/mail.png',
			'resources/img/elements/mail/text-arrow.png',
			'resources/img/elements/mail/text-bg.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/fullstats/list/hover-bg.png',
			'resources/img/elements/fullstats/simple/a-active.png',
			'resources/img/elements/fullstats/simple/a-hover.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/checkbox/checked-active.png',
			'resources/img/elements/checkbox/checked-disabled.png',
			'resources/img/elements/checkbox/checked-hover.png',
			'resources/img/elements/checkbox/checked-normal.png',
			'resources/img/elements/checkbox/unchecked-active.png',
			'resources/img/elements/checkbox/unchecked-disabled.png',
			'resources/img/elements/checkbox/unchecked-hover.png',
			'resources/img/elements/checkbox/unchecked-normal.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/radiobutton/checked-active.png',
			'resources/img/elements/radiobutton/checked-disabled.png',
			'resources/img/elements/radiobutton/checked-hover.png',
			'resources/img/elements/radiobutton/checked-normal.png',
			'resources/img/elements/radiobutton/unchecked-active.png',
			'resources/img/elements/radiobutton/unchecked-disabled.png',
			'resources/img/elements/radiobutton/unchecked-hover.png',
			'resources/img/elements/radiobutton/unchecked-normal.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/colorpicker/arrow.png',
			'resources/img/elements/colorpicker/bg.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/forms/icon-error.png',
			'resources/img/elements/forms/icon-success.png',
			'resources/img/elements/forms/tooltip-error-arrow.png',
			'resources/img/elements/forms/tooltip-error.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/profile/change-active-bg.png',
			'resources/img/elements/profile/change-hover-bg.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/search/arrow.png',
			'resources/img/elements/search/glass.png',
			'resources/img/elements/search/list-hover.png',
			'resources/img/elements/search/loading.gif'
		]);

		mango.utils.preload([
			'resources/img/elements/select/bg-active.png',
			'resources/img/elements/select/bg-hover.png',
			'resources/img/elements/select/bg-right-hover.png',
			'resources/img/elements/select/list-hover-bg.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/settings/header-bg.png',
			'resources/img/elements/settings/header-current-bg.png',
			'resources/img/elements/settings/header-hover-bg.png',
			'resources/img/elements/settings/seperator-current-left.png',
			'resources/img/elements/settings/seperator-current-right.png',
			'resources/img/elements/settings/seperator.png'
		]);

		mango.utils.preload([
			'resources/img/elements/slide-unlock/lock-slider.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/spinner/arrow-down-active.png',
			'resources/img/elements/spinner/arrow-down-hover.png',
			'resources/img/elements/spinner/arrow-up-active.png',
			'resources/img/elements/spinner/arrow-up-hover.png',
			'resources/img/elements/table/pagination/active.png',
			'resources/img/elements/table/pagination/disabled.png',
			'resources/img/elements/table/pagination/hover.png',
			'resources/img/elements/table/toolbar/hover.png',
			'resources/img/elements/table/sorting-asc.png',
			'resources/img/elements/table/sorting-desc.png',
			'resources/img/elements/table/sorting.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/tags/bg.png',
			'resources/img/elements/tags/left.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/to-top/active.png',
			'resources/img/elements/to-top/hover.png',
			'resources/img/elements/to-top/normal.png'
		]);
		
		mango.utils.preload(['resources/img/elements/tooltips/bg.png']);
		
		mango.utils.preload([
			'resources/img/elements/upload/bg-hover.png',
			'resources/img/elements/upload/bg-normal.png'
		]);
		
		mango.utils.preload([
			'resources/img/elements/wizard/arrow-current.png',
			'resources/img/elements/wizard/arrow-error.png',
			'resources/img/elements/wizard/arrow-normal.png',
			'resources/img/elements/wizard/arrow-success.png',
			'resources/img/elements/wizard/bg-current.png',
			'resources/img/elements/wizard/bg-error.png',
			'resources/img/elements/wizard/bg-normal.png',
			'resources/img/elements/wizard/bg-success.png',
			'resources/img/elements/wizard/bg.png'
		]);
		
		mango.utils.preload([
			'resources/img/external/chosen-sprite.png'
		]);
		
		mango.utils.preload([
			'resources/img/external/colorpicker/blank.gif',
			'resources/img/external/colorpicker/colorpicker_background.png',
			'resources/img/external/colorpicker/colorpicker_hex.png',
			'resources/img/external/colorpicker/colorpicker_hsb_b.png',
			'resources/img/external/colorpicker/colorpicker_hsb_h.png',
			'resources/img/external/colorpicker/colorpicker_hsb_s.png',
			'resources/img/external/colorpicker/colorpicker_indic.gif',
			'resources/img/external/colorpicker/colorpicker_overlay.png',
			'resources/img/external/colorpicker/colorpicker_rgb_b.png',
			'resources/img/external/colorpicker/colorpicker_rgb_g.png',
			'resources/img/external/colorpicker/colorpicker_rgb_r.png',
			'resources/img/external/colorpicker/colorpicker_select.gif',
			'resources/img/external/colorpicker/colorpicker_submit.png',
			'resources/img/external/colorpicker/custom_background.png',
			'resources/img/external/colorpicker/custom_hex.png',
			'resources/img/external/colorpicker/custom_hsb_b.png',
			'resources/img/external/colorpicker/custom_hsb_h.png',
			'resources/img/external/colorpicker/custom_hsb_s.png',
			'resources/img/external/colorpicker/custom_indic.gif',
			'resources/img/external/colorpicker/custom_rgb_b.png',
			'resources/img/external/colorpicker/custom_rgb_g.png',
			'resources/img/external/colorpicker/custom_rgb_r.png',
			'resources/img/external/colorpicker/custom_submit.png',
			'resources/img/external/colorpicker/select.png',
			'resources/img/external/colorpicker/select2.png',
			'resources/img/external/colorpicker/slider.png'
		]);
		
		mango.utils.preload([
			'resources/img/external/editor/buttons.gif',
			'resources/img/external/editor/toolbar.gif'
		]);
		
		mango.utils.preload([
			'resources/img/external/explorer/arrows-active.png',
			'resources/img/external/explorer/arrows-normal.png',
			'resources/img/external/explorer/crop.gif',
			'resources/img/external/explorer/dialogs.png',
			'resources/img/external/explorer/icons-big.png',
			'resources/img/external/explorer/icons-small.png',
			'resources/img/external/explorer/logo.png',
			'resources/img/external/explorer/progress.gif',
			'resources/img/external/explorer/quicklook-bg.png',
			'resources/img/external/explorer/quicklook-icons.png',
			'resources/img/external/explorer/resize.png',
			'resources/img/external/explorer/spinner-mini.gif',
			'resources/img/external/explorer/toolbar.png'
		]);
		
		mango.utils.preload([
			'resources/img/external/gallery/blank.gif',
			'resources/img/external/gallery/fancybox_buttons.png',
			'resources/img/external/gallery/fancybox_loading.gif',
			'resources/img/external/gallery/fancybox_sprite.png'
		]);
		
		mango.utils.preload([
			'resources/img/external/jquery-ui/ui-bg_flat_0_000000_40x100.png',
			'resources/img/external/jquery-ui/ui-bg_flat_30_000000_40x100.png',
			'resources/img/external/jquery-ui/ui-bg_flat_65_e3e3e3_40x100.png',
			'resources/img/external/jquery-ui/ui-bg_flat_75_ffffff_40x100.png',
			'resources/img/external/jquery-ui/ui-bg_glass_55_fbf9ee_1x400.png',
			'resources/img/external/jquery-ui/ui-bg_highlight-hard_100_f0f0f0_1x100.png',
			'resources/img/external/jquery-ui/ui-bg_highlight-soft_100_e8e8e8_1x100.png',
			'resources/img/external/jquery-ui/ui-bg_highlight-soft_75_b3bfcb_1x100.png',
			'resources/img/external/jquery-ui/ui-bg_inset-soft_95_fef1ec_1x100.png',
			'resources/img/external/jquery-ui/ui-icons_222222_256x240.png',
			'resources/img/external/jquery-ui/ui-icons_2e83ff_256x240.png',
			'resources/img/external/jquery-ui/ui-icons_3a4450_256x240.png',
			'resources/img/external/jquery-ui/ui-icons_454545_256x240.png',
			'resources/img/external/jquery-ui/ui-icons_888888_256x240.png',
			'resources/img/external/jquery-ui/ui-icons_cd0a0a_256x240.png'
		]);
		
		mango.utils.preload([
			'resources/img/external/uploader/backgrounds.gif',
			'resources/img/external/uploader/buttons-disabled.png',
			'resources/img/external/uploader/buttons.png',
			'resources/img/external/uploader/delete.gif',
			'resources/img/external/uploader/done.gif',
			'resources/img/external/uploader/error.gif',
			'resources/img/external/uploader/throbber.gif',
			'resources/img/external/uploader/transp50.png'
		]);
		
		mango.utils.preload([
			'resources/img/jquery-ui/accordion-header-active.png',
			'resources/img/jquery-ui/accordion-header-hover.png',
			'resources/img/jquery-ui/accordion-header.png',
			'resources/img/jquery-ui/datepicker/arrow-left.png',
			'resources/img/jquery-ui/datepicker/arrow-right.png',
			'resources/img/jquery-ui/datepicker/button-bg.png',
			'resources/img/jquery-ui/datepicker/button-hover-bg.png',
			'resources/img/jquery-ui/datepicker/button-seperator.png',
			'resources/img/jquery-ui/datepicker/day-current.png',
			'resources/img/jquery-ui/datepicker/day-hover.png',
			'resources/img/jquery-ui/datepicker/days-of-week-bg.png',
			'resources/img/jquery-ui/datepicker/header-bg.png',
			'resources/img/jquery-ui/datepicker/time-bg.png',
			'resources/img/jquery-ui/datepicker/top-arrow.png',
			'resources/img/jquery-ui/dialog-titlebar-close-hover.png',
			'resources/img/jquery-ui/dialog-titlebar.png',
			'resources/img/jquery-ui/loading.gif',
			'resources/img/jquery-ui/progressbar/bg.png',
			'resources/img/jquery-ui/progressbar/fill-blue-small.png',
			'resources/img/jquery-ui/progressbar/fill-blue.gif',
			'resources/img/jquery-ui/progressbar/fill-blue.png',
			'resources/img/jquery-ui/progressbar/fill-grey.gif',
			'resources/img/jquery-ui/progressbar/fill-grey.png',
			'resources/img/jquery-ui/progressbar/fill-orange-small.png',
			'resources/img/jquery-ui/progressbar/fill-orange.gif',
			'resources/img/jquery-ui/progressbar/fill-orange.png',
			'resources/img/jquery-ui/progressbar/fill-red-small.png',
			'resources/img/jquery-ui/progressbar/fill-red.gif',
			'resources/img/jquery-ui/progressbar/fill-red.png',
			'resources/img/jquery-ui/slider/bg-range.png',
			'resources/img/jquery-ui/slider/bg.png',
			'resources/img/jquery-ui/slider/disabled-bg-range.png',
			'resources/img/jquery-ui/slider/disabled-bg.png',
			'resources/img/jquery-ui/slider/disabled-picker.png',
			'resources/img/jquery-ui/slider/disabled-vertical-bg-range.png',
			'resources/img/jquery-ui/slider/disabled-vertical-bg.png',
			'resources/img/jquery-ui/slider/disabled-vertical-picker.png',
			'resources/img/jquery-ui/slider/picker.png',
			'resources/img/jquery-ui/slider/vertical-bg-range.png',
			'resources/img/jquery-ui/slider/vertical-bg.png',
			'resources/img/jquery-ui/slider/vertical-picker.png'
		]);
